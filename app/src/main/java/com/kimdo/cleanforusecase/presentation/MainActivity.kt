...
import com.kimdo.cleanforusecase.ui.theme.CleanForUseCaseTheme
            ...
            CleanForUseCaseTheme {
                ...
                Surface(
                    ...
                    , verticalArrangement = Arrangement.Center) {
                        TextField(value = state.email, onValueChange = { viewModel.onEvent(RegistrationFormEvent.EmailChanged(it)) },
